# Onyinyechi Ihesiulo - Data Science Portfolio
...
| [Credit Card Fraud Detection](https://github.com/OnyiChi/Data-Science-Project/tree/main/machine_learning/classification/Credit_Card_Fraud_Detection) | This project aims at detecting fraudulent transactions in credit card data. The project leverages machine learning techniques, particularly Logistic Regression, to distinguish between legitimate and fraudulent transactions. | Pandas, Data balancing (Under-sampling), Logistic Regression, Accuracy score computation, Python, Scikit-learn |
